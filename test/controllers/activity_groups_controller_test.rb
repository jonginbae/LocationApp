...
class ActivityGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_group" do
    assert_difference('ActivityGroup.count') do
      post activity_groups_url, params: { activity_group: { activity_id: @activity_group.activity_id, confirm: @activity_group.confirm, student_id: @activity_group.student_id } }
    end
  ...
  test "should update activity_group" do
    patch activity_group_url(@activity_group), params: { activity_group: { activity_id: @activity_group.activity_id, confirm: @activity_group.confirm, student_id: @activity_group.student_id } }
